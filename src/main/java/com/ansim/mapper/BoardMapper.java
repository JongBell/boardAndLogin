...
public interface BoardMapper {
    // 안심 동행 게시물 목록 보기
    public List<BoardDTO> selectList(Map<String, Object> data) throws Exception;
    ...
    //게시물 등록 하기
    public void updateWrite(BoardDTO board)throws Exception;

    //게시물 상세 내용 보기
    public BoardDTO selectView(int seqno)throws Exception;
